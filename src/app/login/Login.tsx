  ...
  return (
    <div style={{ height: "100vh !important" }} className={`loginHeader`}>
      <Row className={`loginBanner`}>
        <Col
          lg={6}
          className=" h-100   justify-content-center d-grid align-items-center"
        >
        ...
        <Col
          className={`justify-content-center d-grid align-items-center  bg-light h-100`}
        >
          <div className={`loginform mb-5 `}>
            <h3 className={`${styles.bannerText}  text-center  `}>Sign In</h3>
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
              <Row
                className={`mt-3 justify-content-center ${styles.dropdownItems}`}
              >
                <Col
                  lg={8}
                  className={`pe-0 mt-3 text-center d-flex justify-content-center ${styles.cities}`}
                >
                  <Form.Control
