        ...
        <Modal
            ...
            <Modal.Body className={`d-grid  ${styles.modal}`}  >
                <Row className='p-0 '>
                    ...
                    <Col md={5} lg={5} className={` h-100 bg-light  d-none justify-content-center d-lg-grid d-sm-none d-md-grid align-items-center ${styles.logoCol}`} >
                    ...
                    <Col md={7} lg={7} className={` h-100    justify-content-center d-grid align-items-center ${styles.SignDiv}`} >
                        <h1 className={`${styles.bannerText}`} >
                            To Reserve this item, please create an account.
                        </h1>
                        <Button onClick={()=>{
                            navigate(pathname)
                            googleLogin()
                            }} className='fs-14 w-100 py-3 mb-3 mt-3' variant='dark' size='lg' ><img className='mx-2' height={23} width={23} src="https://www.svgrepo.com/download/448227/google.svg" />Sign up with Google</Button>
                        <div className={`${styles.signup_content__line_break}`}>
                            <div className={`${styles.divider}`}></div>
                            <div className={`${styles.signup_content__or}`}>or</div>
                        </div>
                        <Button onClick={() => router.push('/login')}  className='fs-14 w-100 py-3 ' variant='outline-light' size='lg' >Continue with email</Button>
                        <div className='mt-4 d-flex justify-content-center'>
                            <span> Don't have an account? <Link className='link text-decoration-underline' href="/signup" >Signup </Link> </span>
                        </div>
                    </Col>
                </Row>
            </Modal.Body>
