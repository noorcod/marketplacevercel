  ...
  const MobileSidebarFilter = ({ isSandwichOpen, setisSandwichOpen ,filtersData,isLoading, setMobileFilter,setFilters}:any) => {
    ...
    return (
      <div className="pos-f-t">
        <div
          className={`bg-light collapse overflow-auto ${
            bstyles.navbarToggleExternalContent
      ...
      <div className="d-flex  mx-4 justify-content-between align-items-centrer">
        ...
        <span onClick={()=>{setisSandwichOpen(false),clearAllFilters()}}>Close X</span>
      </div>
   ...
   {isSandwichOpen&&   <div
      ...
      >
        ...
        <Button onClick={() => setisSandwichOpen(false)} className={`${styles.apply} w-100  me-5`} variant="secondary  ">
          {" "}
          Apply{" "}
        </Button>
      </div>}
