                    ...
                    <div className={`${styles.bannerTextWrapper}`}>
                        ...
                        <Form>
                                ...
                                <Col className='pe-0'>
                                    <div className={`position-relative d-flex align-items-center ${styles.dropdowns}`}>
                                        ...
                                        <Form.Select className='border-dark border-end-0 ps-4 py-2 rounded-0 rounded-start'>
                                            <option value="All" className='border-0 ps-0'>All Cities</option>
                                            <option value="" className='border-0'>Lahore</option>
                                ...
                                <Col className='ps-0'>
                                    <div className={`position-relative d-flex align-items-center ${styles.dropdowns}`}>
                                        ...
                                        <Form.Select className='border-dark ps-4 py-2 rounded-0 rounded-end'>
                                            <option value="All" className='border-0 ps-0'>All products</option>
                            ...
                            <div className='text-center mb-0'>
                                <Link href={"/"} className='link text-center'>Find all filters {">"}</Link>
                            </div>
                        </Form>
                    </div>
                </Col>
