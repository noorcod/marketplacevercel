        ...
        <Slider {...settings}>
          <div>
            <div
              ...
              className={`${styles.bannerWrapper1}`}
            >
            </div>
          </div>
          <div>
            ...
            className={`${styles.bannerWrapper1}`}></div>
          </div>
          <div>
            <div  
              style={{
        ...
        <Row className={`${styles.bannerInner} flex-lg-row flex-column-reverse`}>
          ...
          <Col className={`mt-md-5 mt-0 p-0`}>
            <div className={`${styles.bannerTextWrapper}`}>
              <h1 className={`${styles.bannerText} text-md-start text-start  text-lg-start`}>
              ...
              <Form>
                <div className={`position-relative d-flex align-items-center ${styles.searchbar}`}>
                  <Image
                    ...
                    height={18}
                  />
                  <Form.Control className="ps-5 border-dark w-100" placeholder="Search by name" />
                </div>
                  ...
                  <Col className={`ps-0  ${styles.condition}`}>
                    ...
                    >
                      ...
                      <Form.Select className="border-dark rounded-0 rounded-end">
                        <option value="All" className="border-0 ps-0 text-secondary">
                          All products
                        </option>
