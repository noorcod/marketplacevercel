...
const ViewList = ({ relatedProducts, paramId }: any) => {
      ...
      <div className="main">
        <div className="text-center mb-1">
          <div className={styles.re_paragraph_div}>
            <h1 className={` ${styles.re_h1} `}> Recently Viewed</h1>
      ...
      <Col className="mt-4" lg="4" md="4" sm="6" xs="6">
        {loading ? (
          ...
          <Card
            ...
            style={
              recomended
                ? { width: "17.7rem", border: " 1px solid #D8E4F8",margin: "0", }
                : { width: "15.3rem", border: " 1px solid #D8E4F8",margin: "0", }
            }
          ...
          >
            ...
            <span className="position-absolute end-0">
              <WishlistIcon listingId={id} title={title} />
            </span>
            ...
            <Card.Body>
              ...
              >
                <p className="fs-18 fw-700 mb-0">{title.replace(/-/g, " ")}</p>
              </Card.Title>
              <div
                className=""
                onClick={() =>
