    ...
    return (
        <>
            ...
            <div className="d-flex justify-content-between align-items-center">
                <h2 className={`mb-0 ${styles.price}`}>$890<sub className={`text-secondary ms-1 text-decoration-line-through ${styles.originalPrice}`}>$1000</sub></h2>
                <div>
            ...
            <Row>
                ...
                <Col xs="8" sm="8" md="8" lg="9">
                    <div><span className="mb-0 text-success fw-bold">In Stock</span> <span className={styles.quantity}>(Only 2 left)</span></div>
                </Col>
            </Row>
            ...
            <div>
                <div className={`d-flex align-items-center gap-3 py-2 px-3 mt-3 mb-2 rounded-1 ${styles.actionBtns}`}>
                    <Image src={phone} alt="call" width={28} height={25} />
                    <div className="ps-1">
                        {showNumbers === false && <h5 className={`fw-bold m-0 ${styles.number}`}>0423783...</h5>}
                        {showNumbers && (<><h5 className={`fw-bold m-0 ${styles.number}`}>03433456974</h5>
                            <h5 className={`fw-bold m-0 ${styles.number}`}>03433456974</h5></>)}
                        {showNumbers === false && <span className="link" onClick={() => setShowNumbers(true)}>Show phone number</span>}
                    </div>
                </div>
                <div className={`d-flex align-items-center gap-3 py-2 px-3 mb-2 rounded-1 ${styles.actionBtnWa}`}>
                    <Col md="1" lg="1" className="p-0">
                        <Image src={whatsapp} alt="whatsapp" width={28} height={25} />
                    </Col>
                    <Col md="10" lg="8" className="p-0">
                        {showWhatsapp === false && <h5 className="fw-bold m-0">0423783...</h5>}
                        {showWhatsapp && <h5 className="fw-bold m-0">03433456974</h5>}
                        {showWhatsapp === false && <span onClick={() => setShowWhatsapp(true)}>Show Whatsapp number</span>}
                        {showWhatsapp && <span>With your valuable questions</span>}
                    </Col>
                    {showWhatsapp && <Col md="1" lg="2" className="p-0 text-center">
                ...
                <Row className={`d-flex align-items-center gap-3 py-2 px-3 rounded-1 w-100 mx-auto ${styles.actionBtns}`}>
                    ...
                    <Col xs="1" sm="1" md="1" lg="1" className="p-0 text-center">
                        <Form.Check type="checkbox" className={styles.checkbox} value={emailForm} onChange={(e) => setEmailForm(e.target.checked)} />
                    </Col>
                </Row>
                {emailForm === true &&
                ...
                <div className={`mt-4`}>
                    ...
                    <Row className={styles.infoSection}>
                        ...
                        <Col xs="3" sm="3" md="3" lg="3" className="px-0 text-center">
                            <Link href="/seller">
                                <Button variant="outline-primary" className="px-md-1">More info</Button>
                            </Link>
                        </Col>
                    </Row>
                </div>
